            ...
            {detail.imp && (
              <li className="flex gap-3 text-red-600 text-[#0F766E] dark:text-[#5EEAD4] flex items-center py-2">
                <span class="relative flex h-3 w-3">
                  <span class="animate-ping absolute inline-flex h-full w-full rounded-full bg-[#0F766E] dark:bg-[#5EEAD4] opacity-75"></span>
                  <span class="relative inline-flex rounded-full h-3 w-3 bg-[#0F766E] dark:bg-[#5EEAD4]"></span>
                </span>
